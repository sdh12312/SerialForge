import { ChevronDown, Cpu, Link2, RefreshCw, Usb } from "lucide-react";
...
export function ConnectionSidebar() {
  ...
  return (
    <Panel className="flex min-w-[260px] flex-col overflow-hidden">
      ...
      <div className="min-h-0 flex-1 space-y-3 overflow-auto p-3">
        ...
        <section className="rounded-xl border border-border bg-background/70 p-3">
          ...
          <p className="mt-2 text-xs text-muted-foreground">
            创建应用内 Virtual Port A/B，A 发送的数据由 B 接收，B 发送的数据由 A 接收。
          </p>
